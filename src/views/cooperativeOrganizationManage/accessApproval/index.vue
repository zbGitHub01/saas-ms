<template>
  <div class="card-wrap">
    ...
    <FormWrap @search="onSearch" @reset="onReset">
      <template #default>
        <el-form inline :model="form">
          ...
          <el-form-item label="准入状态" v-if="approveType === '0'">
          ...
          <el-form-item label="拒绝原因" v-if="approveType === '2'">
            <el-select v-model="form.value5" placeholder="请选择拒绝原因">
              <el-option
    ...
    <el-table :data="state.tableData">
      ...
      <el-table-column label="准入状态" prop="name" min-width="150" v-if="approveType === '0'"></el-table-column>
      ...
      <el-table-column label="资料提交截止日" prop="submitTime" min-width="180"></el-table-column>
      <el-table-column label="审批截止日" prop="submitTime" min-width="180"></el-table-column>
      ...
      <el-table-column label="审核拒绝时间" prop="name" min-width="150" v-if="approveType === '2'"></el-table-column>
      <el-table-column label="拒绝原因" prop="name" min-width="150" v-if="approveType === '2'"></el-table-column>
      <el-table-column label="拒绝人" prop="name" min-width="150" v-if="approveType === '2'"></el-table-column>
      ...
      <el-table-column label="操作" prop="name" width="190" fixed="right">
        <template #default="scope">
          <el-button type="primary" link @click="onDetail(scope.row)">查看资料并审核</el-button>
        </template>
      </el-table-column>
    </el-table>
    <pagination
...
const getOptionList = async () => {
  ...
  const { code2, data2 } = await Apis.configList(params2)
  if (code2 !== 200) return
  optionData.rejectReasonList = data2
}
const handleForm = () => {
